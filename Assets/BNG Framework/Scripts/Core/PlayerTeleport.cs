...
using Sigtrap.VrTunnellingPro; //added
...
namespace BNG {
    ...
    public class PlayerTeleport : MonoBehaviour {
        ...
        private TunnellingMobile tunneling; //added
        private SmoothLocomotion smoothLocomotion; //added
        ...
        void setupVariables() {
            ...
            smoothLocomotion = transform.GetComponent<SmoothLocomotion>(); //added
            tunneling = cameraRig.GetComponentInChildren<TunnellingMobile>(); //added
        ...
        public virtual void BeforeTeleportFade() {
            ...
            if (smoothLocomotion && !smoothLocomotion.isMoving) tunneling.enabled = false; //added
        }
        ...
        public virtual void AfterTeleport() {
            ...
            if (tunneling) tunneling.enabled = true; //added
        }
        ...
        public virtual bool KeyDownForTeleport() {
            ...
            else if (ControlType == TeleportControls.AButton) { //added
                return input.AButton;
            }
            else if (ControlType == TeleportControls.XButton) { //added
