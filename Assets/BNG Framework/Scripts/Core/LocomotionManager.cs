...
namespace BNG {
    public class LocomotionManager : MonoBehaviour {
        ...
        public void UpdateTeleportStatus() {
            teleport.enabled = SelectedLocomotion == LocomotionType.Teleport || SelectedLocomotion == LocomotionType.Both; //changed
        }
        ...
        public void ChangeLocomotionType(LocomotionType loc) {
            ...
            toggleTeleport(selectedLocomotion == LocomotionType.Teleport || selectedLocomotion == LocomotionType.Both); //changed
            toggleSmoothLocomotion(selectedLocomotion == LocomotionType.SmoothLocomotion || selectedLocomotion == LocomotionType.Both); //changed
        }
